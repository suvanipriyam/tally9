                  ...
                  <div className="col-md-12 col-12">
                    <div className="client-border-2 mt-3 mb-3">
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-4">
                          <img
                            src="/images/tally_data_recovery_glowIPS_delhi.jpg"
                  ...
                  <div className="col-md-12 col-12">
                    <div className="client-border-2 mt-3 mb-3">
                      ...
                      <div className="row flex-direction-reverse">
                        ...
                        <div className="col-md-4">
                          <img
                            src="/images/tally_eror_tranmngr900_glowips.PNG"
                  ...
                  <div className="col-md-12 col-12">
                    <div className="client-border-2 mt-3 mb-3">
                      ...
                      <div className="row flex-direction-reverse">
                        ...
                        <div className="col-md-4">
                          <img
                            src="/images/File_Size_Position_Chars.PNG"
                            alt="Tally Data Recovery Glow IPS"
                            style={{ filter: 'invert(0)' }}
                          />
                        </div>
                  ...
                  <div className="col-md-12 col-12">
                    <div className="client-border-2 mt-3 mb-3">
                      ...
                      <div className="row flex-direction-reverse">
                        ...
                        <div className="col-md-4">
                          <img
                            src="/images/Exiting Tally Error - Internel Error - Memory Access Violation.PNG"
                            alt="Tally Data Recovery Glow IPS"
                            style={{ filter: 'invert(0)' }}
                          />
                        </div>
                  ...
                  <div className="col-md-12 col-12">
                    <div className="client-border-2 mt-3 mb-3">
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-4">
                          <img
                            src="/images/Exiting Tally Error - File Not Found.PNG"
                            alt="Tally Data Recovery Glow IPS"
                            style={{ filter: 'invert(0)' }}
                          />
                        </div>
                  ...
                  <div className="col-md-12 col-12">
                    <div className="client-border-2 mt-3 mb-3">
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-4">
                          <img
                            src="/images/Exiting Tally Error - File Damaged Manager.500.PNG"
                            alt="Tally Data Recovery Glow IPS"
                            style={{ filter: 'invert(0)' }}
                          />
                        </div>
